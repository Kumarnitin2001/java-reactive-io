...
//		memoizeMap.putIfAbsent(number, returnCount);
	...
	public static void main(String[] args) {
		PracticeProblemAlphaCoding problem = new PracticeProblemAlphaCoding();
//		System.out.println(problem.representations("332"));
//		System.out.println(problem
//				.representations("213233256544534546213123342423423123123411213123123121312").size());
		long beginTime = System.currentTimeMillis();
		System.out.println(problem.representationsCount(
		...
		System.out.println(problem.memoizeMap.size());
	}
